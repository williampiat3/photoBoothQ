...
if __name__ == "__main__":
	...
	picture_sounds = load_sounds("sound_booth/camera-shutter1.ogg","sound_booth/camera-shutter3.ogg","sound_booth/camera-shutter8.ogg","sound_booth/chinese-gong.ogg","sound_booth/Cuckoo-clock.ogg","sound_booth/party_horn.ogg")
	#opening window
	window = pygame.display.set_mode((1058, 595),RESIZABLE)
	window.fill([255,255,255])
	pygame.display.flip()
	#loading different screens 
	welcomes = load_batch_images("picture_camera/ap_right.png","picture_camera/ap.png","picture_camera/ap_left.png")
